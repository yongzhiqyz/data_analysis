...
BSD License
利用RNN训练一个字母级别的语言模型。也就是说，给RNN输入巨量的文本，然后让其建模并根据一个序列中的前一个字母，
给出下一个字母的概率分布。这样就使得我们能够一个字母一个字母地生成新文本了。
http://blog.csdn.net/u014595019/article/details/52571966
"""
...
# data I/O
data = open('280.txt', 'rb').read() # should be simple plain text file
